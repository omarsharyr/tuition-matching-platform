...
export default function TutorDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const submittedJobs = applications.filter(app => app.status === 'submitted').length;
      ...
      setKpis({
        ...
        submittedJobs: submittedJobs || statsRes.data?.submittedJobs || 0,
  ...
  const handleApplyToJob = async (jobId) => {
    try {
      ...
      setKpis(prev => ({
        ...prev,
        submittedJobs: prev.submittedJobs + 1,
  ...
  const handleWithdrawApplication = async (applicationId) => {
    try {
      ...
      setKpis(prev => ({
        ...prev,
        submittedJobs: Math.max(0, prev.submittedJobs - 1)
      }));
    ...
    <div className={`tutor-layout ${isSidebarCollapsed ? 'sidebar-collapsed' : 'sidebar-expanded'}`}>
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi-card submitted">
          ...
          <div className="kpi-main">
            <div className="kpi-value">{kpis.submittedJobs}</div>
          ...
          <div className="kpi-stats">
            <div className="stat-row">
              ...
              <span className="stat-value">{kpis.submittedJobs - kpis.shortlistedJobs}</span>
            </div>
          </div>
        </div>
        ...
        <div className="section-card jobs-section">
          <div className="section-header">
            ...
            <div className="section-tabs">
              ...
              >
                Submitted ({myApplications.length})
              </button>
              <button 
          ...
          <div className="jobs-list">
            {activeTab === 'browse' ? (
              ...
              getFilteredJobs().map((job) => {
                const hasSubmitted = myApplications.some(app => app.jobId === job._id);
                return (
                  <div key={job._id || job.id} className="job-item">
                    ...
                    <div className="job-actions">
                      ...
                      {activeTab === 'eligible' && !hasSubmitted && (
                        <button 
                          className="btn-apply" 
                          title="Apply now"
              ...
              myApplications.slice(0, 3).map((application) => (
                <div key={application._id || application.id} className="application-item">
                  <div className="application-info">
                    ...
                    <div className="application-date">Submitted: {new Date(application.createdAt).toLocaleDateString()}</div>
                  </div>
